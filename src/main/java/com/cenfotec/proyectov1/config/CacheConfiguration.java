package com.cenfotec.proyectov1.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.cenfotec.proyectov1.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.cenfotec.proyectov1.repository.UserRepository.USERS_BY_EMAIL_CACHE);
